...
echo ">>> creating new car and try to store it into the ledger..."

# channel_name chaincode_name org args @peers
chaincodeInvoke global history factory '{"function":"NewCar","Args":["1FAFP55U91A180689", "Ford Taurus"]}' auditor factory dealer police insurance
